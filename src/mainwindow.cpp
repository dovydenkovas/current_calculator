...
MainWindow::MainWindow(): QMainWindow() {
    ...
    scheme->setPixmap(QPixmap::fromImage(QImage("images/circuit.png")));
    ...
    input_frame->setFont(QFont("Arial",14));
...
void MainWindow::keyPressEvent(QKeyEvent *event) {
    if (event->key() == Qt::Key_F1) {
        QMessageBox::information(this, "Информация о программе","Эта программа предназначена для нахождения токов в цепи.\nВерсия 0.1-b");
    }
 }
